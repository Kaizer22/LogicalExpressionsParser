...
public class Parser {
    ...
    void parse(String expression){
        ...
        Leaf initial = new Leaf(lexemes); //Вершина дерева
        buildTree(initial); //Построение дерева
        System.out.println(lexemes.toString());
        printTree(initial); //Вывод дерева на экран
    ...
    //Запуск парсинга набора тестовых выражений
    void test(String[] expressions){
        for (String test_line: expressions) {
            parse(test_line);
